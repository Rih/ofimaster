	...
	//debe ser generado por vista!!
 	function llenarTabla(tabla){
		...
		tabla.forEach( function(currVal, index, arr) {
			...
			console.log(index);
			console.log(arr);
			var idrow = currVal.idcategory;
			var famnamerow = currVal.family_name;
			var catenamerow = currVal.category_name;
 			...
 			<div class="row wrapper border-bottom white-bg page-heading animated fadeInDown">
                <div class="col-lg-9">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong style="font-weight: 600; color: #dd3d1d;">Gestión de Categorías</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-3">
                	...
                	<button onClick=modalChange(1,'<?php echo site_url().$uriadd ?>',nameform,title_add,title_text_add,0,0) class="btn btn-primary dim btn-large-dim" data-toggle="modal" data-target="#myModal">
						<i class="fa fa-plus" aria-hidden="true"></i> Crear Categoría
					</button>
                </div>
            </div>
	                ...
	                <div class="col-md-12">
	                    <div class="ibox float-e-margins">
	                        <div class="ibox-title">
		                        <h5>Tabla de Registros de Categorías</h5>
	...
	function llenarDatos(idrow){
		...
		for (var i=0;i<datos_tabla.length;i++){
   			if(datos_tabla[i].idcategory == idrow){
   				...
   				$("#name").val(datos_tabla[i].category_name);
