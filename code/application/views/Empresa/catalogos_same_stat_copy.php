			                    ...
			                    <div class="row clear-form"><!-- row -->
									<div class="col-md-12" style="margin-bottom:10px;"><!-- col12 -->
										...
										<div class="i-checks" style="width: 130px; float: left;"><label>
											<input type="radio" onchange="doExtension(this.value)" value="pdf" name="extension1" checked> <i></i> Archivo .PDF </label>
										</div>
										<div class="i-checks"><label>
											<input type="radio" onchange="doExtension(this.value)" value="rar" name="extension2" checked> <i></i> Archivo .RAR (Comprimido)</label>
										</div>
		  							</div><!-- col12 -->
								</div><!-- row -->
							</div><!-- ibox-content -->
			...
			<div class="wrapper wrapper-content animated fadeInRight" style="padding-bottom:80px;"><!-- wrapper-content -->
				<div class="row"><!-- row -->
					<div class="col-lg-3 col-xs-3"><!-- col-lg-3 -->
						<div class="ibox">
							<div class="ibox-content product-box">
								<div class="product-imitation" style="background: url('http://www.ofimaster.cl/code/template/images/generaPDF.png') no-repeat center;background-size: cover;"></div>
								<div class="product-desc">
									<span class="product-price"> 110MB (PDF) / 29MB (RAR)</span>
									<small class="text-muted">Categoría Químicos de Aseo</small>
									<div  class="product-name">
										003 Catálogo de Químicos de Aseo
									</div>
									<div class="small m-t-xs">Catálogo descargable en formato PDF de la categoría Químicos de Aseo con 255 productos disponibles en nuestra bodega.</div>
									<div class="btn-group" style="margin:10px 0; width: 100%;">
			                            <button data-toggle="dropdown" class="btn btn-warning btn-sm dropdown-toggle btn-download" aria-expanded="false"><i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i> Descargar <span class="caret"></span></button>
			                            <ul class="dropdown-menu">
			                                <li><a href="http://www.ofimaster.cl/static/003-quimicosdeaseo.pdf" download="003-quimicosdeaseo.pdf" download>Descargar en .PDF</a></li>
			                                <li><a href="http://www.ofimaster.cl/static/003-quimicosdeaseo.rar">Descargar en .RAR</a></li>
			                            </ul>
			                        </div>
								</div>
							</div>
					...
					<div class="col-lg-3 col-xs-3"><!-- col-lg-3 -->
						<div class="ibox">
							<div class="ibox-content product-box">
								<div class="product-imitation" style="background: url('http://www.ofimaster.cl/code/template/images/generaPDF.png') no-repeat center;background-size: cover;"></div>
								<div class="product-desc">
									<span class="product-price"> 52MB (PDF) / 12MB (RAR)</span>
									<small class="text-muted">Categoría Papelería de Aseo</small>
									<div  class="product-name">
										004 Catálogo de Papelería de Aseo
									</div>
									<div class="small m-t-xs">Catálogo descargable en formato PDF de la categoría Papelería de Aseo con 94 productos disponibles en nuestra bodega.</div>
									<div class="btn-group" style="margin:10px 0; width: 100%;">
			                            <button data-toggle="dropdown" class="btn btn-warning btn-sm dropdown-toggle btn-download" aria-expanded="false"><i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i> Descargar <span class="caret"></span></button>
			                            <ul class="dropdown-menu">
			                                <li><a href="http://www.ofimaster.cl/static/004-papeleriadeaseo.pdf" download="004-papeleriadeaseo.pdf" download>Descargar en .PDF</a></li>
			                                <li><a href="http://www.ofimaster.cl/static/004-papeleriadeaseo.rar">Descargar en .RAR</a></li>
			                            </ul>
			                        </div>
								</div>
							</div>
					...
					<div class="col-lg-3 col-xs-3"><!-- col-lg-3 -->
						<div class="ibox">
							<div class="ibox-content product-box">
								<div class="product-imitation" style="background: url('http://www.ofimaster.cl/code/template/images/generaPDF.png') no-repeat center;background-size: cover;"></div>
								<div class="product-desc">
									<span class="product-price"> 66MB (PDF) / 13MB (RAR)</span>
									<small class="text-muted">Categoría Accesorios de Aseo</small>
									<div  class="product-name">
										005 Catálogo de Accesorios de Aseo
									</div>
									<div class="small m-t-xs">Catálogo descargable en formato PDF de la categoría Accesorios de Aseo con 157 productos disponibles en nuestra bodega.</div>
									<div class="btn-group" style="margin:10px 0; width: 100%;">
			                            <button data-toggle="dropdown" class="btn btn-warning btn-sm dropdown-toggle btn-download" aria-expanded="false"><i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i> Descargar <span class="caret"></span></button>
			                            <ul class="dropdown-menu">
			                                <li><a href="http://www.ofimaster.cl/static/005-accesoriosdeaseo.pdf" download="005-accesoriosdeaseo.pdf" download>Descargar en .PDF</a></li>
			                                <li><a href="http://www.ofimaster.cl/static/005-accesoriosdeaseo.rar">Descargar en .RAR</a></li>
			                            </ul>
			                        </div>
								</div>
							</div>
					...
					<div class="col-lg-3 col-xs-3"><!-- col-lg-3 -->
						<div class="ibox">
							<div class="ibox-content product-box">
								<div class="product-imitation" style="background: url('http://www.ofimaster.cl/code/template/images/generaPDF.png') no-repeat center;background-size: cover;"></div>
								<div class="product-desc">
									<span class="product-price"> 20MB (PDF) / 3MB (RAR)</span>
									<small class="text-muted">Categoría Equipos</small>
									<div  class="product-name">
										006 Catálogo de Equipos
									</div>
									<div class="small m-t-xs">Catálogo descargable en formato PDF de la categoría Equipos con 21 productos disponibles en nuestra bodega.</div>
									<div class="btn-group" style="margin:10px 0; width: 100%;">
			                            <button data-toggle="dropdown" class="btn btn-warning btn-sm dropdown-toggle btn-download" aria-expanded="false"><i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i> Descargar <span class="caret"></span></button>
			                            <ul class="dropdown-menu">
			                                <li><a href="http://www.ofimaster.cl/static/006-equipos.pdf" download="006-equipos.pdf" download>Descargar en .PDF</a></li>
			                                <li><a href="http://www.ofimaster.cl/static/006-equipos.rar">Descargar en .RAR</a></li>
			                            </ul>
			                        </div>
								</div>
							</div>
					...
					<div class="col-lg-3 col-xs-3"><!-- col-lg-3 -->
						<div class="ibox">
							<div class="ibox-content product-box">
								<div class="product-imitation" style="background: url('http://www.ofimaster.cl/code/template/images/generaPDF.png') no-repeat center;background-size: cover;"></div>
								<div class="product-desc">
									<span class="product-price"> 24MB (PDF) / 3MB (RAR)</span>
									<small class="text-muted">Categoría Seguridad</small>
									<div  class="product-name">
										007 Catálogo de Seguridad
									</div>
									<div class="small m-t-xs">Catálogo descargable en formato PDF de la categoría Seguridad con 37 productos disponibles en nuestra bodega.</div>
									<div class="btn-group" style="margin:10px 0; width: 100%;">
			                            <button data-toggle="dropdown" class="btn btn-warning btn-sm dropdown-toggle btn-download" aria-expanded="false"><i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i> Descargar <span class="caret"></span></button>
			                            <ul class="dropdown-menu">
			                                <li><a href="http://www.ofimaster.cl/static/007-seguridad.pdf" download="007-seguridad.pdf" download>Descargar en .PDF</a></li>
			                                <li><a href="http://www.ofimaster.cl/static/007-seguridad.rar">Descargar en .RAR</a></li>
			                            </ul>
			                        </div>
								</div>
							</div>
