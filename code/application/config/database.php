...
$active_group = 'production'; //default
$active_record = TRUE;

$db['development']['hostname'] = '127.0.0.1'; //o localhost
$db['development']['username'] = 'root';
$db['development']['password'] = 'tibia';
$db['development']['database'] = 'servicio_carga';
...
$db['production']['username'] = 'ofimaste_cdmkrs';
$db['production']['password'] = 'wbmstr321';//'zu79pm5GaF'; 
$db['production']['database'] = 'ofimaste_code';
