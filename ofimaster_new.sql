...
-- -----------------------------------------------------
-- Schema ofimaste_code
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema ofimaste_code
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ofimaste_code` DEFAULT CHARACTER SET utf8 ;
USE `ofimaste_code` ;
...
CREATE TABLE IF NOT EXISTS `ofimaste_code`.`product` (
  ...
  `idsubcategory_fk` INT NULL COMMENT 'Validar category - subcategory\ndesde la App Web',
...
CREATE TABLE IF NOT EXISTS `ofimaste_code`.`company` (
  ...
  `business_name` VARCHAR(30) NULL COMMENT 'business_name = razon social',
  `RUT` VARCHAR(15) NULL,
  `company_name` VARCHAR(30) NULL COMMENT 'company_name = nombre fantasia',
  `line_of_business` VARCHAR(70) NULL COMMENT 'line_of_business = giro',
